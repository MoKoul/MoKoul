...
`dbt Core` · `Google BigQuery` · `PostgreSQL` · `Azure SQL`
...
###  [Inventory-Analytics-Dashboard](https://github.com/MoKoul/Inventory-Analytics-Dashboard)
...
> `Azure` · `SQL-Server` · `Power BI` . `Python`
